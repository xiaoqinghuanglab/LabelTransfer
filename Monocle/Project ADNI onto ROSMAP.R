...
expression_matrix_tmp <- read.csv("/Users/xiaoqing/Library/CloudStorage/OneDrive-IndianaUniversity/R.Projects/ADNI/Processed Data/ADNI_blood_gene_expression_gene_aligned_04172023_ExpMatrix.csv", header=FALSE)
cell_metadata <- read.csv("/Users/xiaoqing/Library/CloudStorage/OneDrive-IndianaUniversity/R.Projects/ADNI/Processed Data/ADNI_blood_gene_expression_gene_aligned_04172023_SampleInfo.csv")
gene_annotation <- read.csv("/Users/xiaoqing/Library/CloudStorage/OneDrive-IndianaUniversity/R.Projects/ADNI/Processed Data/ADNI_blood_gene_expression_gene_aligned_04172023_GeneInfo.csv")
...
write.csv(DF, file="/Users/xiaoqing/Library/CloudStorage/OneDrive-IndianaUniversity/R.Projects/ADNI/Processed Data/Monocle_LabelTransfer_ROSMAP_ADNI_Braak.csv")
